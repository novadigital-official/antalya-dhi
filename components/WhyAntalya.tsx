...
import { Sun, Building2, Plane, Hotel, Check } from 'lucide-react';
  ...
  return (
    <div id="why-antalya" className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-7xl mx-auto">
        {reasons.map((r, idx) => (
          <div key={idx} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs flex flex-col justify-between space-y-3 card-hover-lift">
            <div>
              <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-4 border border-blue-100/80">
