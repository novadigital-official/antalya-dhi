...
export default function WhatsAppWidget() {
  ...
  return (
    <a 
      ...
      className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center justify-center cursor-pointer group"
    >
      {/* Inner WhatsApp Sphere Button */}
      <div className="w-13 h-13 sm:w-14 sm:h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-xl flex items-center justify-center transition-all duration-200 group-hover:scale-105 border border-white/20">
