...
export const translations = {
  en: {
    ...
    'process.step3.desc': 'VIP airport pickup, hotel check-in, and painless DHI hair transplant under sterile hospital conditions by certified surgeons.',
    ...
    'packages.standard_includes': 'Maximum Graft DHI Operation in Licensed Hospital|Painless Needle-Free Anesthesia|Post-Op Medication & Special Shampoo Kit|Lifetime Warranty Certificate|Active WhatsApp Post-Op Support Line',
    ...
    'packages.vip_includes': 'Full DHI Operation & Maximum Grafts in Licensed Hospital|VIP Mercedes Vito Airport & Clinic Transfers|1 Night Luxury Hotel Accommodation|Multilingual Patient Coordinator (EN/FR/TR)|PRP & Mesotherapy Session|Active WhatsApp Post-Op Support Line',
  ...
  fr: {
    ...
    'process.step3.desc': 'Accueil VIP à l\'aéroport, hébergement et greffe DHI indolore dans un environnement stérile par des chirurgiens certifiés.',
    'process.step4.num': '04',
    ...
    'packages.standard_includes': 'Opération DHI en Hôpital Agréé|Anesthésie Sans Aiguille|Médicaments & Kit Spécial Shampoing|Certificat de Garantie à Vie|Ligne de Support WhatsApp Active',
    'packages.vip_name': 'VIP Antalya Experience',
    'packages.vip_title': 'VIP Antalya Experience',
    'packages.vip_desc': 'Expérience Tourisme Médical & Confort VIP (Séjour Tout Compris)',
    'packages.vip_popular': 'LE PLUS RECOMMANDÉ',
    'packages.vip_includes': 'Opération DHI Complète en Hôpital Agréé|Transferts VIP en Mercedes Vito Aéroport & Clinique|1 Nuit d\'Hébergement en Hôtel de Luxe|Coordinateur Multilingue (FR/EN/TR)|Séance PRP & Mésothérapie|Ligne de Support WhatsApp Active',
  ...
  tr: {
    ...
    'packages.standard_includes': 'Ruhsatlı Hastanede DHI Operasyonu (Maksimum Greft)|İğnesiz Konforlu Anestezi|İlaçlar & Özel Şampuan Bakım Kiti|Ömür Boyu Garanti Sertifikası|Aktif WhatsApp Destek Hattı',
    'packages.vip_name': 'VIP Antalya Experience',
    'packages.vip_title': 'VIP Antalya Experience',
    ...
    'packages.vip_includes': 'Ruhsatlı Hastanede Tam DHI Operasyonu|VIP Mercedes Vito Havaalanı & Klinik Transferleri|1 Gece Otel Konaklaması|Çok Dilli Hasta Koordinatörü (TR/EN/FR)|PRP & Mezoterapi Seansı|Aktif WhatsApp Destek Hattı',
